...
def model_save(fn, model, criterion):
...
def train(model, optimizer, criterion, args, train_data, params, epoch=0, max_steps=-1, discard_highest_losses=0.0):
    ...
    if max_steps >= 0:
        n_batches = min(max_steps, n_batches)
    while i < train_data.size(0) - 1 - 1 and not(0 <= max_steps < batch):
        # Warmup
        ...
        if batch % args.log_interval == 0 and batch > 0:
            ...
            print('| epoch {:3d} | {:5d}/{:5d} batches | lr {:05.5f} | ms/batch {:5.2f} | '
                ...
                epoch, batch, n_batches, optimizer.param_groups[0]['lr'],
        ...
        for epoch in range(1, args.epochs+1):
            ...
            if 't0' in optimizer.param_groups[0]:
                ...
                if epoch in args.when:
                    ...
                    model_save('{}.e{}'.format(args.save, epoch), model, criterion)
